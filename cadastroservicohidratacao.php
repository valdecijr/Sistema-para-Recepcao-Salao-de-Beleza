...
if($teste == $servicos){
        ...
        echo"<script language='javascript' type='text/javascript'>alert('Esse Cliente jᡦoi cadastrado!   Fale com Seu supervisor se tiver alguma duvida sobre isso!');window.location.href='menudeservicos.php';</script>";
        die();
