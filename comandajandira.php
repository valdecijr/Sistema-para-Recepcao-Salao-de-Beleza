...
<section class=" navbar-fixed-top navbar" role="navigation">
	<div class="container">
		<div class="navbar-header">
			...
			<ul class="nav navbar-nav navbar-right">
				<li><a href="controleproducaoadmjandira.php" class="smoothScroll">Consulte a produção (Jandira)</a></li>
			</ul>
		</div>
			</div>
...
<form id="cadastro" name="cadastro" method="post" action="cadastrocomandajandira.php" onsubmit="return validaCampo(); return false;">
  <table width="625" border="0">
  <tr>      <td>Codigo do cliente:</td>  
  <td><input name="codigoclijandira" class="form-control" type="text" id="codigoclijandira" maxlength="100" />       <br>    </tr>  
  <td>Profissional:</td>
<td> 
<select name="profissionaljandira" class="form-control" id="profissionaljandira" />
        <option>Selecione...</option>
		<option value="Jandira / Estética">Jandira / Estética</option>
</select>
		  </tr>
	...
	<br>
      ...
      <td> <select name="servico1jandira" class="form-control" id="servico1jandira" />
        <option>Selecione...</option>
	...
	<br>
      ...
      <td> <select name="servico2jandira" class="form-control" id="servico2jandira" />
        <option>Selecione...</option>
		...
		<option value="Auriculterapia 45 minutos / 1x 70,00 / 7x 400,00">Auriculterapia 45 minutos / 1x 70,00 / 7x 400,00</option>
		  ...
		  <tr>     
		  <td>Bebidas:</td>    
		  <td> <select name="bebidasjandira" class="form-control" id="bebidasjandira" />       
 <option>Selecione...</option>     
 ...
 <tr>    
 <td>Valor Total</td>     
 <td><input name="vtotaljandira" class="form-control" type="text" id="vtotaljandira" maxlength="100" />      
 <br>   
 </tr>		
 <tr>     
 <td>Data</td>   
 <td><input name="datajandira" class="form-control" type="date" id="datajandira" maxlength="100" />       <br>    </tr>
	<tr>
      <td>Observação:</td>
      <td><input name="obsjandira" class="form-control" type="text" id="obsjandira" maxlength="100" />
       <br>
    </tr>
	<tr>      <td>Comissão:</td>      <td><input name="comissaojandira" class="form-control" type="text" id="comissaojandira" maxlength="100" />       <br>    </tr>
     <tr>
      <td colspan="2"><p>
