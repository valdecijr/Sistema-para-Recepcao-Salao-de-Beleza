...
<tr>
  ...
  <br>
  <li class="list__item">
   <input type="radio" class="radio-btn" name="opcaomanicure1" value="mao" id="opcaomanicure1" />
   <label for="opcaomanicure1" class="label">Mão</label>
  </li>
  <li class="list__item">
   <input type="radio" class="radio-btn" name="opcaomanicure2" value="pe" id="opcaomanicure2" />
   <label for="opcaomanicure2" class="label">Pé</label>
  </li>
   <br>
   <br>
