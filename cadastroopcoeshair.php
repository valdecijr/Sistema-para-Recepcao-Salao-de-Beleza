...
$id	= $_POST ["id"];
$nome	= $_POST ["nome"];
$opcaohair1	= $_POST ["opcaohair1"];
$opcaohair2	= $_POST ["opcaohair2"];
...
$teste = "SELECT * FROM escolhashair WHERE id = '$id'";
...
$query = "INSERT INTO `escolhashair` ( `id`, `nome` ,  `opcaohair1`, `opcaohair2` )
VALUES (NULL, '$nome', '$opcaohair1', '$opcaohair2'
);";
