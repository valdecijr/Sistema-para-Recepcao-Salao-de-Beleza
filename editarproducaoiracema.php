...
$tt = mysql_query("SELECT * FROM comandasiracema where ID = '$id' ");
...
<div class="container">
<form id="cadastro" name="cadastro" method="post" action="updatecomissaoiracema.php" onsubmit="return validaCampo(); return false;">
  <table width="625" border="0">
   <tr>
      <input name="id" type="hidden" id="id" size="30" maxlength="30" value="<?php echo $row['id']; ?>"/> 
	  <br>
	<br>		<tr>	<td>Codigo do cliente</td>      <td><input name="codigocliiracema" class="btn-default btn" type="text" id="codigocliiracema" size="30" maxlength="30" value="<?php echo $row['codigocliiracema'];  ?>" />	  <br>	<br>    </tr>
	<br>
	<tr>
	<td>Profissional</td>
      <td><input name="profissionaliracema" class="btn-default btn" type="text" id="profissionaliracema" size="30" maxlength="30" value="<?php echo $row['profissionaliracema'];  ?>" />
	  <br>
	<br>
    </tr>
	<br>
    ...
    <tr>
      ...
      <td width="546"><input name="servicoiracema" class="btn-default btn" type="text" id="servicoiracema" size="30" maxlength="30" value="<?php echo $row['servicoiracema'];  ?>" />
	  <br>
	<br>
    </tr>
	<br>
	<tr>
      ...
      <td width="546"><input name="bebidasiracema" class="btn-default btn" type="text" id="bebidasiracema" size="30" maxlength="30" value="<?php echo $row['bebidasiracema'];  ?>" />
<br>
	<br>
    </tr>		<tr>      <td>Valor Total</td>      <td><input name="vtotaliracema" class="btn-default btn" type="text" id="vtotaliracema" maxlength="30" value="<?php echo $row['vtotaliracema'];  ?>" />	<br>	<br>	<tr>		<tr>      <td>Data</td>      <td><input name="datairacema" class="btn-default btn" type="text" id="datairacema" maxlength="30" value="<?php echo $row['datairacema'];  ?>" />	<br>	<br>	<tr>      <td>Horario</td>      <td><input name="horarioiracema" class="btn-default btn" type="text" id="horarioiracema" maxlength="30" value="<?php echo $row['horarioiracema'];  ?>" />	<br>		<tr>
	<br>
	<tr>
      <td>Observações</td>
      <td><input name="obsiracema" class="btn-default btn" type="text" id="obsiracema" maxlength="30" value="<?php echo $row['obsiracema'];  ?>" />
	<br>
	<br>
	<tr>
	<tr>
      <td>Comissão</td>
      <td><input name="comissaoiracema" class="btn-default btn" type="text" id="comissaoiracema" maxlength="30" value="<?php echo $row['comissaoiracema'];  ?>" />
	<br>
        ...
        <br>
		<center><a href="controleproducaoadmiracema.php" class="btn btn-danger">Voltar!</a></center>
          <br>
     </tr>
  </table>
</form>
